...
from project.bert_trainer import BertTrainer as Trainer
from project.bert_dataset import TextClassificationDataset, TextClassificationCollator
from project.utils import read_text
